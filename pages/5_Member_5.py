...
Insight highlights, Decision support) for Member 5's theme.

HOW TO MAKE IT YOURS
  1. Edit your entry (id=5) in  src/config.py  (name, theme_title, metrics...).
  2. Drop your cleaned CSV into  data/member5/ .
